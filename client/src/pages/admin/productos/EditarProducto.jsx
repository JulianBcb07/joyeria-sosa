...
function EditarProducto() {
    return (
        <>
            <div>
                <h1 className='text-4xl font-bold text-center pb-5'>Editar producto</h1>
                <div className='bg-white py-10 px-6 mb-10 max-w-4xl mx-auto shadow-lg rounded-lg'>
                    <form action="">
                        ...
                        <input type="file" className='w-full my-3 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600' />
                        <button type="submit"
