            ...
            <div>
                ...
                <div className='bg-white py-10 px-6 max-w-4xl mx-auto shadow-lg rounded-lg'>
                    <form action="" encType='multipart/form-data'>
                        ...
                        <label htmlFor="" className='font-medium'>Cargar imagen de categoría</label>
                        <input type="file" name='img_category' className='w-full my-3 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600' />
                        <button type="submit"
